...
export function DailyView({
  ...
  const appointmentsForDay = appointments.filter(appt => isSameDay(appt.startTime, day));

  return (
    <div className="grid grid-cols-[auto_1fr] overflow-x-auto">
      <div className="col-start-1" />
      <div className="text-center py-2 border-b border-l col-start-2">
      ...
      {timeSlots.map((time, timeIndex) => {
        ...
        const appointmentsInSlot = appointmentsForDay.filter(
          (appt) =>
